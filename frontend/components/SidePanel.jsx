  ...
  return (
    <aside className="sidepanel" id="sidepanel" aria-label="Design panel">
      <div className="panel-body">
        {/* Slides */}
        <section className="group" aria-label="Slides">
          <div className="group-title">Slides</div>
          <div className="row">
        ...
        {/* Image */}
        <section className="group" aria-label="Image">
        ...
        {/* Presets */}
        <section className="group" aria-label="Presets">
        ...
        {/* Event */}
        <section className="group" aria-label="Event" id="mapGroup">
